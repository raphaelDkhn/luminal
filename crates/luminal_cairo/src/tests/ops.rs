...
// fn test_matmul() {
//     let mut cx = Graph::new();
//     let a_data = random_vec(25 * 25);
//     let b_data = random_vec(25 * 25);
//     let a = cx.tensor((25, 25)).set(a_data.clone());
//     let b = cx.tensor((25, 25)).set(b_data.clone());
...
//     let d_dev = Cpu::default();
//     let d_a = d_dev.tensor_from_vec(a_data, (DConst::<25>, DConst::<25>));
//     let d_b = d_dev.tensor_from_vec(b_data, (DConst::<25>, DConst::<25>));
